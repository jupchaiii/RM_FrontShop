const faqs = [
  ...
  },
  {
    ...
    a: 'คำนวณตามน้ำหนักวัสดุ ค่าไฟฟ้า ค่าเครื่องจักร ค่าแรง วัสดุสิ้นเปลือง และบรรจุภัณฑ์ แล้วคูณ risk multiplier และ margin ตามสูตรราคากลางของระบบ ราคาที่แสดงคือราคาสุทธิ',
  },
  {
